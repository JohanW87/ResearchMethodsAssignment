turtles-own
  [ sick?                ;; if true, the turtle is infectious
    ...
    keeps-distance?       ;; how long, in weeks, the turtle has been infectious
    tested-positive?       ;; how long, in weeks, the turtle has been infectious
...
globals
  ...
  ;; the lifespan of a turtle
    total-deaths             ;; the lifespan of a turtle
    chance-reproduce     ;; the probability of a turtle generating an offspring each tick
    carrying-capacity    ;; the number of turtles that can be in the world at one time
    social-distancing-compliance-number ;; number of turtels that keep distance
...
to RunAllExperiment
  carefully [ file-delete "testResults.txt" ] [ ]
   change-compliance-setup-10-times-go
   change-testing-setup-10-times-go
end

to change-testing-setup-10-times-go
  set UseTesting True
  set social-distancing-compliance 80
  set get-tested-ticks 0
  setup-10-times-go
  set get-tested-ticks 5
  setup-10-times-go
  set get-tested-ticks 10
  setup-10-times-go
  set get-tested-ticks 15
  setup-10-times-go
  set get-tested-ticks 20
  setup-10-times-go
  set get-tested-ticks 25
  setup-10-times-go
  set get-tested-ticks 30
  setup-10-times-go
  set get-tested-ticks 35
  setup-10-times-go
  set get-tested-ticks 40
  setup-10-times-go

end

to change-compliance-setup-10-times-go
  set UseTesting false
  set social-distancing-compliance 0
  setup-10-times-go
    set social-distancing-compliance 10
  setup-10-times-go
    set social-distancing-compliance 20
  setup-10-times-go
    set social-distancing-compliance 30
  setup-10-times-go
  set social-distancing-compliance 40
  setup-10-times-go
    set social-distancing-compliance 50
  setup-10-times-go
    set social-distancing-compliance 60
  setup-10-times-go
    set social-distancing-compliance 70
  setup-10-times-go
    set social-distancing-compliance 80
  setup-10-times-go
    set social-distancing-compliance 90
  setup-10-times-go
    set social-distancing-compliance 100
  setup-10-times-go
end
to setup-10-times-go
  setup-go
  setup-go
  setup-go
  setup-go
...
to setup-turtles
  ...
  ask n-of 20 turtles
    [ get-sick ]
  set social-distancing-compliance-number social-distancing-compliance / 100 * number-people
  ask n-of social-distancing-compliance-number turtles
    [ get-compliant ]
end

to get-compliant ;; turtle procedure
  set keeps-distance? true
end

to get-tested ;; turtle procedure
  if UseTesting and get-tested-ticks > 0 and ticks mod get-tested-ticks = 0 and ticks > get-tested-ticks [
    if sick?
    [
...
to move ;; turtle procedure
  ...
  [
    rt random 100
    lt random 100
    if tested-positive? and any? other turtles with [ not tested-positive?] and keeps-distance?
    [
      face min-one-of other turtles with [not tested-positive? ] [distance myself]
      rt 180
    ]
    if not tested-positive? and any? other turtles with [ tested-positive? ] in-radius 3 and keeps-distance?
    [
      face min-one-of other turtles with [ tested-positive? ] in-radius 3 [distance myself]
      rt 180
      ;rt random 100
      ;lt random 100
    ]
...
to write-global-variables
  if count turtles > 0
    [
      file-open "testResults.txt"
      file-write carrying-capacity
      file-write infectiousness
      file-write chance-recover
      file-write duration
      file-write social-distancing-compliance
      file-write UseTesting
      file-write get-tested-ticks
      file-write ticks
      file-write count turtles with [ keeps-distance? ]
      file-write count turtles with [ sick? ]
      file-write count turtles with [ immune? ]
      file-write count turtles with [ not sick? and not immune? ]
      file-write count turtles with [ tested-positive? ]
      file-write count turtles
      file-write %infected
      file-write %immune
      file-write total-deaths
      file-print ""
      file-close
  ]
end
...
"tested positive" 1.0 0 -955883 true "" "plot count turtles with [ tested-positive? ]"
"total-deaths" 1.0 0 -6459832 true "" "plot total-deaths"
